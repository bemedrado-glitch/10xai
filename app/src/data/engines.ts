...
export const ENGINES: EngineDetail[] = [
  {
    ...
    valueProp:
      "Reverse-prospecting for local SMBs. We find them, build them a website with AI, and reach out  before any inbound funnel.",
    longDesc:
      "About 3 million U.S. small businesses have a Google Business Profile and zero website. Their reviews prove demand. Their absence proves opportunity. Lighthouse finds them, generates a tailored 5-section site from their reviews and photos in 60 seconds, and runs a personalized 7-day outbound cadence  email, WhatsApp, Instagram. The hook: a live preview link of their site, ready to deploy under their own domain.",
    details: [
    ...
    whoFor: [
      "Marketing agencies that want to land local SMB clients faster",
      "Operators in markets where ~30% of strong-review businesses still have no website",
      "Studios and consultants targeting dental, home services, beauty, restaurants",
      "Anyone who needs a wedge product with built-in proof of demand",
    ],
    features: [
      {
        title: "Review-driven discovery",
        desc: "We pull Google Business Profiles in your target city and vertical, filter for 4.5+ stars and 20+ reviews, and surface only the businesses without a website.",
      },
      {
        title: "AI site generation in 60 seconds",
        desc: "Claude reads the reviews and photos, drafts a hero, services list, review wall, hours, and contact form. The site stages on a preview URL ready to claim.",
      },
      {
        title: "Personalized outbound cadence",
        desc: "7-day sequence  email, WhatsApp, Instagram DM  each touch references the actual business, the actual reviews, and the actual preview URL.",
      },
      {
        title: "Compliant by design",
        desc: "CAN-SPAM, LGPD, and regional outreach laws baked in. Opt-out one-click. Volume-throttled to keep sender reputation clean.",
      },
    ],
    process: [
      { week: "Week 1", deliverable: "Define geo + vertical, pull 100200 qualified prospects, draft outreach voice." },
      { week: "Week 2", deliverable: "Generate 50100 site previews, human-in-loop QA gate, launch first cadence batch." },
      { week: "Week 3", deliverable: "Conversations  reply triage, demo calls, conversion to paid setup + hosting." },
      { week: "Week 4", deliverable: "Measure: reply rate, call rate, close rate. Tune cadence + targeting for cohort 2." },
    ],
    integrations: ["Google Business Profile API", "Cal.com", "WhatsApp Business", "Resend", "Claude (Anthropic)", "Vercel preview deployments"],
